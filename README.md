...
- [Skiplists - a probabilistic data structure](data%20structures/2020-09-04_skiplists---a-probabilistic-data-structure.md)
...
- [Open a repo in a browser from Magit](emacs/2021-06-02_open-a-repo-in-a-browser-from-magit.md)
...
- [ActiveJob.perform_now doesn't run execute callback](rails/2022-07-19_activejob.perform_now-doesn%27t-run-execute-callback.md)
...
- [Using TIOCGWINSZ](ruby/2022-08-12_using-tiocgwinsz.md)
